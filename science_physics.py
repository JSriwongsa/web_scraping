...
def get_max_start_page():
    ...
    all of the data
    """
    base_url = 'https://www.science.org/topic/category/physics?'
...
def perform():
    ...
    max_start_page_size = get_max_start_page()
    ...
    for start_page in start_page_range:
        ...
        h2_text = get_h2_text_from_page(url)
